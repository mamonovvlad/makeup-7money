...
<!--        <button-->
<!--          class="btn_back shadow_btn_white bg-background-main"-->
<!--          v-if="back"-->
<!--          @click="$emit('backCurrency')"-->
<!--        >-->
<!--          <i class="icon-trash"></i>-->
<!--        </button>-->
<!--        <button-->
<!--          class="btn_exchange shadow_btn_white bg-background-main"-->
<!--          v-if="exchangeBlocksActive"-->
<!--        >-->
<!--          <svg>-->
<!--            <rect />-->
<!--          </svg>-->
...
<!--        <input-->
<!--          class="bg-background-main text-copy-descr shadow_btn_white_active"-->
<!--          id="get"-->
<!--          type="number"-->
<!--          placeholder="12 214 122, 88 rub"-->
<!--        />-->
<!--        <div class="inp_img">-->
...
<!--    },-->
<!--    backCurrency() {-->
<!--      this.$emit("backCurrency", (this.selectionBlocksActive = true));-->
<!--    }-->
<!--  }-->
<!--  // watch: {-->
<!--  //   currentTime(time) {-->
