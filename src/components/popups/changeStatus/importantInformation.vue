<template>
  <div class="status_window">
    <div class="status_window_box status_window_grey">
      <div class="close">
        <svg
          width="13"
          height="13"
      ...
      <div class="status_window_img">
        <img src="/source/image/ChangeStatus/importantInformation.svg" alt />
      </div>
      <p class="status_window_title text-copy-descr">№01244123</p>
      <p class="status_window_descr text-copy-descr">
        Клиент в статусе заявки Вас ждет важная информация по Вашему обмену
      </p>
    </div>
  </div>
</template>
